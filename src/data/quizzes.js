...
},
{
  ...
  ,
  {
    id: 'b2-reported-speech-quiz',
    lessonId: 'b2-reported-speech-01',
    title: 'Reported Speech Check',
    questions: [
      { id: 'rs-q01', type: 'multiple-choice', prompt: 'She said: "I am tired." — Which reported speech form is correct?', options: ['She said she is tired.', 'She said she was tired.', 'She told she was tired.', 'She said me she was tired.'], correctIndex: 1, explanation: 'Use "said" without an object. Backshift: am → was. "Told" requires a direct object ("told me"), and "said me" is incorrect.' },
      { id: 'rs-q02', type: 'multiple-choice', prompt: '"We will call you tomorrow," they said. — Which is correct?', options: ['They said they will call me the next day.', 'They said they would call me the next day.', 'They told they would call me tomorrow.', 'They said they would called me the next day.'], correctIndex: 1, explanation: '"Will" backshifts to "would". "Tomorrow" changes to "the next day" in reported speech. "Told" needs an object.' },
      { id: 'rs-q03', type: 'multiple-choice', prompt: 'He told ___ to leave immediately.', options: ['that she', 'to her', 'her', 'she'], correctIndex: 2, explanation: 'Pattern: tell + object pronoun (object form) + to-infinitive. "Her" is the correct object pronoun.' },
      { id: 'rs-q04', type: 'multiple-choice', prompt: '"Where do you work?" she asked me. — Which is correct?', options: ['She asked me where do I work.', 'She asked me where did I work.', 'She asked me where I worked.', 'She asked me where I work.'], correctIndex: 2, explanation: 'In reported questions, word order returns to normal (subject + verb). "Do" is removed and "work" backshifts to "worked".' },
      { id: 'rs-q05', type: 'multiple-choice', prompt: '"Don\'t be late!" the teacher said to us. — Which is correct?', options: ['The teacher said us not to be late.', 'The teacher told us not to be late.', 'The teacher told us to not late.', 'The teacher said to us to not be late.'], correctIndex: 1, explanation: 'Reported negative commands: told + object + not + to-infinitive. "Said us" is wrong — "tell" requires a direct object without "to".' },
      { id: 'rs-q06', type: 'multiple-choice', prompt: '"I have finished the report," he said. — Which is correct?', options: ['He said he finished the report.', 'He said he has finished the report.', 'He said he had finished the report.', 'He told he had finished the report.'], correctIndex: 2, explanation: 'Present perfect ("have finished") backshifts to past perfect ("had finished"). "Told" requires a direct object.' },
      { id: 'rs-q07', type: 'multiple-choice', prompt: '"Can you help me?" she asked him. — Which is correct?', options: ['She asked him if he can help her.', 'She asked him if he could help her.', 'She asked him could he help her.', 'She asked him whether could he help her.'], correctIndex: 1, explanation: 'Yes/no questions use "if" or "whether". "Can" backshifts to "could". Word order is normal — no inversion.' },
      { id: 'rs-q08', type: 'multiple-choice', prompt: 'Which sentence uses a reporting verb correctly?', options: ['She suggested to take a break.', 'She suggested taking a break.', 'She suggested us to take a break.', 'She suggested that we to take a break.'], correctIndex: 1, explanation: '"Suggest" is followed by gerund (-ing) or a "that" clause, never "to + infinitive". ✅ "suggested taking" or "suggested that we take".' },
      { id: 'rs-q09', type: 'multiple-choice', prompt: '"I was sleeping when you called," she said. — Correct reported form?', options: ['She said she was sleeping when I had called.', 'She said she had been sleeping when I called.', 'She said she had been sleeping when I had called.', 'She said she has been sleeping when I called.'], correctIndex: 1, explanation: 'Past continuous ("was sleeping") backshifts to past perfect continuous ("had been sleeping"). The time clause "when I called" stays in simple past.' },
      { id: 'rs-q10', type: 'multiple-choice', prompt: 'He denied ___ the window.', options: ['to break', 'break', 'breaking', 'that break'], correctIndex: 2, explanation: '"Deny" is followed by a gerund (-ing form). Pattern: deny + verb-ing.' },
      { id: 'rs-q11', type: 'fill-in-blank', prompt: 'Direct: "I can\'t come to the meeting," she said.\nReported: She said she ___ come to the meeting.', answer: "couldn't", acceptedVariants: ["couldn't", 'could not'], explanation: '"Can\'t" backshifts to "couldn\'t" in reported speech.' },
      { id: 'rs-q12', type: 'fill-in-blank', prompt: 'Direct: "Are you ready?" he asked her.\nReported: He asked her ___ she was ready.', answer: 'if', acceptedVariants: ['if', 'whether'], explanation: 'Yes/no questions are reported using "if" or "whether".' },
      { id: 'rs-q13', type: 'fill-in-blank', prompt: 'Direct: "I have never been to London," she told him.\nReported: She told him she ___ never been to London.', answer: 'had', acceptedVariants: ['had'], explanation: 'Present perfect ("have been") backshifts to past perfect ("had been").' },
      { id: 'rs-q14', type: 'sentence-scramble', prompt: 'เรียงคำให้เป็นประโยค reported speech ที่ถูกต้อง:', words: ['She', 'asked', 'where', 'I', 'had', 'been', '.'], explanation: 'Reported wh-questions use normal word order: question word + subject + verb. "Where had I been?" → "where I had been".' },
      { id: 'rs-q15', type: 'sentence-scramble', prompt: 'เรียงคำให้เป็นประโยค reported command ที่ถูกต้อง:', words: ['The', 'manager', 'told', 'us', 'not', 'to', 'make', 'noise', '.'], explanation: 'Reported negative commands: told + object + not + to-infinitive.' }
    ]
  },
  {
    id: 'b2-complaints-quiz',
    lessonId: 'b2-complaints-01',
    title: 'Complaints & Apologies Check',
    questions: [
      { id: 'ca-q01', type: 'multiple-choice', prompt: 'You are in a restaurant and your food is wrong. Which opening is most appropriate?', options: ['This is wrong. Change it.', "I'm afraid there's a problem with my order.", 'Maybe there is a small issue, possibly, I think.', "Never mind, it's fine."], correctIndex: 1, explanation: 'Option B uses a softening phrase ("I\'m afraid") and states the problem clearly and politely. Option A is too blunt, Option C too vague, Option D avoids the problem entirely.' },
      { id: 'ca-q02', type: 'multiple-choice', prompt: 'A customer says: "I\'ve called three times and nothing has been done." Which response best acknowledges their frustration?', options: ["That's not my department.", "I'm sorry you feel that way.", "I completely understand your frustration — that's not acceptable, and I'll look into it right away.", 'You should have emailed instead of calling.'], correctIndex: 2, explanation: 'Option C validates feelings, accepts the problem, and promises action. "I\'m sorry you feel that way" is a non-apology. Options A and D deflect responsibility.' },
      { id: 'ca-q03', type: 'multiple-choice', prompt: 'Which sentence is an example of polite escalation?', options: ['I want to speak to your boss RIGHT NOW.', "I'd like to speak to a manager, please — I've raised this twice without a resolution.", "Fine, I'll just leave a bad review.", 'You people never listen.'], correctIndex: 1, explanation: 'Option B requests a manager politely, states facts calmly, and explains the reason. The others use threats, aggression, or personal attacks.' },
      { id: 'ca-q04', type: 'multiple-choice', prompt: 'Your colleague made a mistake on a report. Which apology shows genuine responsibility?', options: ["I'm sorry you noticed the mistake.", "It wasn't really my fault — the data was unclear.", 'That was entirely my fault. I sincerely apologise and will correct it immediately.', 'Well, everyone makes mistakes.'], correctIndex: 2, explanation: 'Option C takes full ownership ("entirely my fault"), uses a sincere apology, and commits to action. The others deflect blame or trivialise the mistake.' },
      { id: 'ca-q05', type: 'multiple-choice', prompt: 'Which phrase offers a solution after a complaint?', options: ["I'd like to offer you a full refund.", "There's nothing we can do.", 'This happens all the time.', 'You should have read the terms and conditions.'], correctIndex: 0, explanation: '"I\'d like to offer you a full refund" is a clear, positive solution. The others dismiss the problem, normalise it, or blame the customer.' },
      { id: 'ca-q06', type: 'multiple-choice', prompt: 'What does it mean to "escalate" a complaint?', options: ['To apologise more sincerely', 'To drop the complaint and move on', 'To refer the problem to a higher level of authority', 'To describe the complaint in more detail'], correctIndex: 2, explanation: 'Escalate means to raise the complaint to a higher level — from a customer service agent to a manager, for example.' },
      { id: 'ca-q07', type: 'multiple-choice', prompt: 'Which phrase best introduces a complaint in a formal workplace email?', options: ['I wanted to bring something to your attention regarding last week\'s project deadline.', 'You messed up the project deadline.', 'I am writing this email because I am very angry.', 'FYI the deadline was missed lol.'], correctIndex: 0, explanation: '"I wanted to bring something to your attention" is a standard professional softening phrase — factual without being accusatory.' },
      { id: 'ca-q08', type: 'multiple-choice', prompt: 'A company offers a free gift card after a complaint, though not legally required to. What is this called?', options: ['A bribe', 'A refund', 'A goodwill gesture', 'An escalation'], correctIndex: 2, explanation: 'A goodwill gesture is something offered voluntarily to maintain a positive relationship, without legal obligation.' },
      { id: 'ca-q09', type: 'multiple-choice', prompt: 'Which word means "to correct a mistake or fix a problem" in a formal register?', options: ['Compensate', 'Rectify', 'Escalate', 'Acknowledge'], correctIndex: 1, explanation: '"Rectify" means to put something right or correct an error, commonly used in formal complaint responses.' },
      { id: 'ca-q10', type: 'fill-in-blank', prompt: "Complete: \"I'm ___ there's a problem with my reservation — I don't appear to be in the system.\"", answer: 'afraid', acceptedVariants: ['afraid'], explanation: '"I\'m afraid" is the standard softening phrase for introducing a complaint politely. It does not mean you are scared — it is a politeness marker.' },
      { id: 'ca-q11', type: 'fill-in-blank', prompt: 'Complete the apology: "That was ___ our fault, and I take full responsibility."', answer: 'entirely', acceptedVariants: ['entirely', 'completely', 'wholly'], explanation: '"Entirely" intensifies the acceptance of blame — "entirely our fault" means 100% our responsibility.' },
      { id: 'ca-q12', type: 'fill-in-blank', prompt: 'Fill in: "We will do everything we can to ___ the situation as quickly as possible."', answer: 'rectify', acceptedVariants: ['rectify', 'resolve', 'fix', 'address'], explanation: '"Rectify" is formal and common in complaint responses. "Resolve" and "address" also work.' },
      { id: 'ca-q13', type: 'fill-in-blank', prompt: "Complete: \"I'd like to speak to a manager, please — I've ___ this issue twice already.\"", answer: 'raised', acceptedVariants: ['raised', 'mentioned', 'reported', 'brought up'], explanation: '"Raised" is the standard verb for formally mentioning a problem ("raise an issue").' },
      { id: 'ca-q14', type: 'word-matching', prompt: 'จับคู่ประโยคกับหน้าที่ของมัน:', pairs: [{ word: "I'm afraid there's a problem with…", match: 'Softening a complaint' }, { word: 'I completely understand your frustration.', match: 'Acknowledging feelings' }, { word: "I'd like to offer you a full refund.", match: 'Offering a solution' }, { word: "I'd like to speak to a manager, please.", match: 'Escalating politely' }], explanation: 'Each phrase has a distinct function in complaint conversations.' },
      { id: 'ca-q15', type: 'word-matching', prompt: 'จับคู่คำศัพท์กับความหมาย:', pairs: [{ word: 'inconvenience', match: 'ความไม่สะดวก' }, { word: 'compensate', match: 'ชดเชย' }, { word: 'acknowledge', match: 'ยอมรับ / รับรู้' }, { word: 'goodwill', match: 'ไมตรีจิต / น้ำใจ' }], explanation: 'คำเหล่านี้ปรากฏบ่อยในภาษาร้องเรียนและขอโทษอย่างเป็นทางการ' }
    ]
  },
  {
    id: 'c2-register-quiz',
    lessonId: 'c2-register-01',
    title: 'Register & Style Check',
    questions: [
      { id: 'reg-q01', type: 'multiple-choice', prompt: 'Which sentence best demonstrates nominalisation in formal academic writing?', options: ['The researchers decided to expand the scope of their investigation.', 'A decision was made to expand the scope of the investigation.', 'They decided that they would expand what they were looking at.', 'An expansion decision regarding investigative scope was arrived at by researchers.'], correctIndex: 1, explanation: 'Option B uses nominalisation ("a decision was made") and passive voice for impersonal formal tone. Option D over-nominalises to the point of unreadability.' },
      { id: 'reg-q02', type: 'multiple-choice', prompt: 'A Thai executive writes to a Board of Directors about a financial shortfall. Which is most register-appropriate?', options: ["We're really in a tight spot financially and things have gone a bit off the rails.", 'The organisation is currently experiencing significant fiscal constraints that necessitate a strategic reassessment of expenditure.', 'There is a money problem and we need to spend less money going forward.', "Financial issues have emerged and it would seem we should probably consider reducing costs somewhat."], correctIndex: 1, explanation: 'Option B uses formal Latinate vocabulary (fiscal, necessitate, expenditure) and appropriate complexity for board-level communication. Option D overhedges to the point of sounding uncertain.' },
      { id: 'reg-q03', type: 'multiple-choice', prompt: 'Which of the following is an example of "hyper-formality" — being overly formal in a way that sounds unnatural?', options: ["I'd appreciate it if you could send me the report by Friday.", 'Please be so kind as to furnish the undersigned with said report at your earliest possible convenience, no later than the aforementioned Friday.', 'The report would be appreciated by end of day Friday.', 'Should you find it feasible, forwarding the report before Friday\'s close of business would be greatly appreciated.'], correctIndex: 1, explanation: 'Option B is hyper-formal — "the undersigned", "said report", "aforementioned Friday" are archaic legal terms that sound robotic in a professional email. Option D is appropriately formal without being absurd.' },
      { id: 'reg-q04', type: 'multiple-choice', prompt: 'In academic writing, hedging ("the data appear to suggest") serves primarily to:', options: ['Make the writing sound more casual and approachable.', 'Acknowledge the limits of claims and protect against overstatement.', 'Add word count to reach the minimum length requirement.', 'Signal that the writer lacks confidence in their research.'], correctIndex: 1, explanation: 'Hedging is a mark of academic sophistication, not weakness. It shows intellectual honesty and protects claims from categorical refutation.' },
      { id: 'reg-q05', type: 'multiple-choice', prompt: 'A speaker opens a keynote with "Thanks so much for coming!" then transitions to "The longitudinal data substantiate a compelling argument for policy reform." What technique is this?', options: ['A register error — the opening was too casual.', 'Code-switching — a deliberate shift from casual/warm to formal/authoritative register.', 'Nominalisation — converting "reform" to a noun.', 'Hedging — softening the policy claim.'], correctIndex: 1, explanation: 'This is deliberate code-switching. The warm casual opening builds rapport; the formal transition signals intellectual seriousness. Skilled speakers do this intentionally.' },
      { id: 'reg-q06', type: 'fill-in-blank', prompt: 'Convert the verb to its nominalised form:\n"The government ___ (intervene) in the market came too late to prevent collapse."', answer: 'intervention', acceptedVariants: ['intervention', "the government's intervention"], explanation: '"Intervention" nominalises "intervene". The formal sentence: "The government\'s intervention in the market came too late to prevent collapse."' },
      { id: 'reg-q07', type: 'fill-in-blank', prompt: 'Replace with a formal Latinate verb:\n"The board agreed to ___ the merger until regulatory approval was obtained." (formal word for "put off")', answer: 'defer', acceptedVariants: ['defer', 'postpone', 'suspend', 'adjourn'], explanation: '"Defer" is the most precise formal choice. "Postpone" also works. All are preferable to "put off" in formal register.' },
      { id: 'reg-q08', type: 'fill-in-blank', prompt: 'Insert a hedging expression:\n"The findings ___ that increased screen time correlates with reduced attention span in adolescents."', answer: 'suggest', acceptedVariants: ['suggest', 'appear to suggest', 'indicate', 'appear to indicate', 'seem to suggest', 'would appear to suggest', 'may suggest'], explanation: 'Any modal or lexical hedge works: "suggest", "indicate", "appear to show". Avoid "prove" unless evidence is exceptionally strong.' },
      { id: 'reg-q09', type: 'word-matching', prompt: 'จับคู่คำศัพท์ไม่เป็นทางการกับคำเทียบเท่าแบบทางการ:', pairs: [{ word: 'find out', match: 'ascertain' }, { word: 'use', match: 'utilise' }, { word: 'show', match: 'demonstrate' }, { word: 'help', match: 'assist' }, { word: 'end', match: 'terminate' }], explanation: 'Formal English draws on Latinate vocabulary: ascertain, utilise, demonstrate, assist, terminate — all carry a more official, distanced tone.' },
      { id: 'reg-q10', type: 'word-matching', prompt: 'จับคู่ register กับตัวอย่างประโยค:', pairs: [{ word: '"Do you solemnly swear to tell the truth?"', match: 'Frozen' }, { word: '"The committee has resolved to defer the proposal."', match: 'Formal' }, { word: '"I\'d recommend we review the figures first."', match: 'Consultative' }, { word: '"We should check those numbers first, right?"', match: 'Casual' }], explanation: 'The four main register levels each have distinct characteristics: frozen (fixed formulas), formal (complex, no contractions), consultative (professional but interactive), casual (everyday).' },
      { id: 'reg-q11', type: 'sentence-scramble', prompt: 'เรียงคำให้เป็น formal academic sentence:', words: ['The', 'data', 'appear', 'to', 'support', 'the', 'hypothesis', 'that', 'early', 'intervention', 'may', 'significantly', 'improve', 'outcomes', '.'], explanation: '"The data appear to support the hypothesis that early intervention may significantly improve outcomes." Note double hedging: "appear to support" + "may significantly improve".' },
      { id: 'reg-q12', type: 'sentence-scramble', prompt: 'เรียงคำให้เป็น formal business email opening:', words: ['I', 'write', 'with', 'reference', 'to', 'your', 'correspondence', 'of', 'the', 'fourteenth', 'of', 'June', 'regarding', 'the', 'proposed', 'contractual', 'amendments', '.'], explanation: '"I write with reference to your correspondence..." — formal features: "I write" (not "I\'m writing"), "correspondence" (not "email"), Latinate vocabulary.' },
      { id: 'reg-q13', type: 'multiple-choice', prompt: 'Which of these is a "false formality" error?', options: ["I'd appreciate it if you could send me the report by Friday.", 'Please be so kind as to furnish the undersigned with said report.', 'The report would be appreciated by end of day Friday.', 'Forwarding the report before Friday would be greatly appreciated.'], correctIndex: 1, explanation: '"Furnish the undersigned" and "said report" are archaic legal locutions — absurd in a professional email. Hyper-formality can undermine credibility.' },
      { id: 'reg-q14', type: 'multiple-choice', prompt: 'The word "super" in "The study\'s results are super important" is wrong in academic writing because:', options: ['It is grammatically incorrect.', 'It is an informal colloquialism inappropriate for academic register.', 'It is a false cognate.', '"Super" can only be used as a prefix, not as an adverb.'], correctIndex: 1, explanation: '"Super" is a colloquialism entirely out of place in academic writing. Replace with "highly significant", "of considerable importance", or "profoundly significant".' },
      { id: 'reg-q15', type: 'fill-in-blank', prompt: 'Complete with the correct formal vocabulary:\n"I am writing to ___ about the availability of conference rooms next Tuesday." (formal word for "ask")', answer: 'enquire', acceptedVariants: ['enquire', 'inquire', 'ask'], explanation: '"Enquire" is the formal British English equivalent of "ask" — used in professional correspondence. "Inquire" is the American spelling variant.' }
    ]
  }
  ,
  {
    id: 'c2-academic-writing-quiz',
    lessonId: 'c2-academic-writing-01',
    title: 'Academic Writing Essentials Check',
    questions: [
      { id: 'aw-q01', type: 'multiple-choice', prompt: 'Which is the strongest academic thesis statement?', options: ['This essay will discuss the effects of globalisation on developing economies.', 'Globalisation has both positive and negative effects on developing economies.', 'Although globalisation has accelerated economic growth in certain emerging markets, its distributional consequences systematically disadvantage rural and informal-sector workers.', 'Globalisation is a very important topic that affects many countries today.'], correctIndex: 2, explanation: 'Option C makes a specific, arguable claim (distributional disadvantage), acknowledges a counterargument, and signals the essay\'s analytical focus. Options A and D are not claims; Option B is too vague.' },
      { id: 'aw-q02', type: 'multiple-choice', prompt: 'Which sentence correctly uses "notwithstanding"?', options: ['Notwithstanding, the results were positive.', 'The results, notwithstanding, suggest a correlation.', 'Notwithstanding the small sample size, the findings align with broader epidemiological trends.', 'The policy failed notwithstanding it was well-funded.'], correctIndex: 2, explanation: '"Notwithstanding" as a preposition must be followed directly by a noun phrase ("the small sample size"), then a comma, then the main clause.' },
      { id: 'aw-q03', type: 'multiple-choice', prompt: 'A student writes: "A lot of research shows that kids who read a lot get better grades." Which revision is most appropriate for academic writing?', options: ['Lots of research demonstrates that kids who read more often get better grades.', 'Substantial research demonstrates that children who engage in frequent independent reading achieve higher academic outcomes.', 'A lot of studies have shown that children who read a lot will get better grades.', 'Research shows that kids reading more leads to better academic results.'], correctIndex: 1, explanation: 'Option B eliminates all informal markers ("a lot of" → "substantial", "kids" → "children", "get better grades" → "achieve higher academic outcomes") and uses precise vocabulary.' },
      { id: 'aw-q04', type: 'multiple-choice', prompt: 'What is the primary function of passive voice in academic writing?', options: ['To make sentences shorter and easier to read', 'To foreground the action or finding rather than the agent, conveying methodological impartiality', 'To comply with rules that prohibit first-person pronouns', 'To make writing sound more intelligent'], correctIndex: 1, explanation: 'Passive voice shifts focus from who did something to what was done or found — especially important in empirical writing where method replicability matters more than individual authorship.' },
      { id: 'aw-q05', type: 'multiple-choice', prompt: 'Which cohesion device correctly completes: "The initial trials produced promising results; _______, the long-term efficacy data remain inconclusive."', options: ['furthermore', 'consequently', 'however', 'in light of this'], correctIndex: 2, explanation: '"However" signals contrast between promising initial results and inconclusive long-term data. "Furthermore" adds a similar or stronger point (wrong here). "Consequently" signals causal consequence (also wrong).' },
      { id: 'aw-q06', type: 'multiple-choice', prompt: 'Which sentence best functions as an academic topic sentence?', options: ['What causes urban poverty is a complex question.', 'Many governments have introduced housing policies.', 'The criminalisation of homelessness represents a structural failure of urban governance to address the root causes of housing insecurity.', 'In 2021, approximately 580,000 people experienced homelessness in the United States.'], correctIndex: 2, explanation: 'Option C makes a specific, arguable claim that requires evidence and analysis. Option A is a question. Option B is a vague observation. Option D is a data point — it belongs in the Illustration stage, not as a topic sentence.' },
      { id: 'aw-q07', type: 'multiple-choice', prompt: '"The experiment was ran by the researchers in three stages." What is wrong with this sentence?', options: ['Passive voice should not be used in scientific writing', '"ran" is the incorrect past participle; it should be "run"', 'The sentence should name the researchers for clarity', '"in three stages" is too informal'], correctIndex: 1, explanation: 'The past participle of "run" is "run", not "ran". The correct form is "was run". Passive voice is entirely appropriate here.' },
      { id: 'aw-q08', type: 'multiple-choice', prompt: 'Which sentence uses "insofar as" correctly?', options: ['Insofar as, the policy was effective in reducing emissions.', 'The policy was effective insofar as it targeted industrial sources directly.', 'The policy was effective, insofar as well as reducing emissions.', 'Insofar the data are complete, conclusions can be drawn.'], correctIndex: 1, explanation: '"Insofar as" introduces a limiting clause: it must be followed by a complete clause specifying the scope of the claim. Option B correctly limits the effectiveness claim to a specific condition.' },
      { id: 'aw-q09', type: 'fill-in-blank', prompt: 'Complete with the most appropriate cohesion device:\n"The survey data indicate strong public support for the reform. _______, qualitative interviews reveal considerable ambivalence among stakeholders directly affected by the changes."', answer: 'Nevertheless', acceptedVariants: ['Nevertheless', 'Nonetheless', 'However', 'Yet'], explanation: '"Nevertheless" or "Nonetheless" is optimal — the second clause concedes that quantitative support exists but maintains a contrasting nuance. "However" is also correct and slightly less emphatic.' },
      { id: 'aw-q10', type: 'fill-in-blank', prompt: 'Replace the informal phrase with a formal academic equivalent:\n"The committee will _______ [look into] the allegations before issuing a formal response."', answer: 'investigate', acceptedVariants: ['investigate', 'examine', 'scrutinise', 'scrutinize', 'review'], explanation: '"Look into" is informal. Formal equivalents: "investigate", "examine", "scrutinise", or "review". "Investigate" is most precise — it implies a structured process to establish facts.' },
      { id: 'aw-q11', type: 'fill-in-blank', prompt: 'Complete using passive voice:\n"The participants _______ [inform] of their right to withdraw at the outset of the study."', answer: 'were informed', acceptedVariants: ['were informed', 'had been informed'], explanation: '"Were informed" is the correct simple past passive for a completed procedural action. "Had been informed" (past perfect passive) is also acceptable if the informing preceded another past action.' },
      { id: 'aw-q12', type: 'fill-in-blank', prompt: 'The phrase "In today\'s world" is a red-flag informal phrase. Replace it with a more precise academic opening for: "___, more and more companies are adopting sustainability targets."', answer: 'In recent decades', acceptedVariants: ['In recent decades', 'In the contemporary era', 'In the current era', 'Over the past two decades', 'At present'], explanation: '"In today\'s world" lacks specificity. Academic writing requires temporal precision: "In recent decades", "Over the past twenty years", or "In the contemporary era" are all acceptable.' },
      { id: 'aw-q13', type: 'sentence-scramble', prompt: 'Arrange to form a grammatically correct academic sentence:', words: ['The', 'aforementioned', 'findings', 'necessitate', 'a', 'reconsideration', 'of', 'the', 'dominant', 'theoretical', 'paradigm', '.'], explanation: '"The aforementioned findings necessitate a reconsideration of the dominant theoretical paradigm." — "aforementioned" pre-modifies "findings"; "necessitate" is the main verb; correct adjective order before "paradigm".' },
      { id: 'aw-q14', type: 'sentence-scramble', prompt: 'Arrange to form a correct academic sentence using a cohesion device:', words: ['Notwithstanding', 'the', 'inconclusive', 'data', ',', 'the', 'researchers', 'proceeded', 'with', 'the', 'second', 'phase', '.'], explanation: '"Notwithstanding the inconclusive data, the researchers proceeded with the second phase." — "Notwithstanding" opens the sentence and takes a noun phrase directly, followed by a comma and main clause.' },
      { id: 'aw-q15', type: 'sentence-scramble', prompt: 'Arrange to form a correct passive-voice academic sentence:', words: ['The', 'qualitative', 'data', 'were', 'analysed', 'by', 'three', 'independent', 'coders', 'to', 'ensure', 'reliability', '.'], explanation: '"The qualitative data were analysed by three independent coders to ensure reliability." — passive moves "the qualitative data" to subject position; "data" takes plural "were" in formal British academic usage.' }
    ]
  },
  {
    id: 'c2-cleft-quiz',
    lessonId: 'c2-cleft-sentences-01',
    title: 'Cleft Sentences Check',
    questions: [
      { id: 'cq-01', type: 'multiple-choice', prompt: 'Which sentence is a correct it-cleft focusing on the time element?', options: ['It was when the war ended in 1945.', 'It was in 1945 that the war ended.', 'It was the war that ended in 1945.', 'That the war ended, it was 1945.'], correctIndex: 1, explanation: 'It-cleft for time: "It was + time expression + that + clause." Option B is correct. Option A omits "that". Option C focuses on "the war", not the time.' },
      { id: 'cq-02', type: 'multiple-choice', prompt: '"What the director did was ______ the entire cast without notice." Which form is correct?', options: ['to dismissing', 'dismissing', 'dismiss', 'dismissed'], correctIndex: 2, explanation: 'In the no-cleft "What + subject + did + was + ___", the verb must be a bare infinitive. "Dismiss" is correct. "Dismissing" (gerund) is non-standard in this structure.' },
      { id: 'cq-03', type: 'multiple-choice', prompt: 'What is the primary communicative function of the all-cleft in "All I want is a quiet evening"?', options: ['To express a negative meaning', 'To restrict and minimise the focus element, implying nothing more is required', 'To focus on the subject of the sentence', 'To indicate a formal register'], correctIndex: 1, explanation: 'The all-cleft restricts scope — "nothing more than this." It minimises the focused element rather than negating it or shifting the subject.' },
      { id: 'cq-04', type: 'multiple-choice', prompt: 'Which sentence contains a reverse pseudo-cleft?', options: ['It was her determination that carried her through.', 'What carried her through was her determination.', 'Her determination is what carried her through.', 'All that carried her through was determination.'], correctIndex: 2, explanation: 'A reverse pseudo-cleft places the focused element FIRST: "[FOCUS] + is + what + clause." Option C is correct. Option B is a standard wh-cleft. Option A is an it-cleft. Option D is an all-cleft.' },
      { id: 'cq-05', type: 'multiple-choice', prompt: 'In "It is the students who are responsible", why is "are" used rather than "is"?', options: ['Because "it" is always singular', 'Because the verb agrees with the focused noun "the students", which is plural', 'Because the relative clause always takes a plural verb', 'It is an exception to normal agreement rules'], correctIndex: 1, explanation: 'In it-clefts, the verb agrees with the FOCUSED NOUN, not with the dummy subject "it". Since "the students" is plural, the verb is "are".' },
      { id: 'cq-06', type: 'multiple-choice', prompt: 'Which transformation correctly converts "They fired him because of his attitude" into a cleft focused on the reason?', options: ['What they did was fire him because of his attitude.', 'It was because of his attitude that they fired him.', 'It was his attitude that they fired him.', 'All they did was fire him for his attitude.'], correctIndex: 1, explanation: 'To focus on a reason (prepositional phrase), use it-cleft: "It was + reason phrase + that + clause." Option B is correct. Option C incorrectly focuses on the noun without the preposition.' },
      { id: 'cq-07', type: 'multiple-choice', prompt: 'Which context is most appropriate for a wh-cleft rather than an it-cleft?', options: ['You want to focus on who performed an action', 'You want to focus on when something happened', 'You want to build up reflectively to a focused idea or conclusion', 'You want to focus on a specific place'], correctIndex: 2, explanation: 'Wh-clefts are effective when building toward a conclusion ("What this analysis reveals is..."). They treat the wh-clause as known information and foreground the comment. It-clefts are more directly contrastive.' },
      { id: 'cq-08', type: 'fill-in-blank', prompt: 'Complete the wh-cleft:\n"What the committee failed to consider ___ the long-term environmental impact."', answer: 'was', acceptedVariants: ['was'], explanation: 'The wh-cleft structure is "What + subject + verb + was + [focused element]." The missing word is "was" — it links the known topic (what the committee failed to consider) to the focused comment (the long-term impact).' },
      { id: 'cq-09', type: 'fill-in-blank', prompt: 'Complete the all-cleft:\n"All the survivors ___ was a safe place to rest and clean water." (correct form of "need", past tense)', answer: 'needed', acceptedVariants: ['needed'], explanation: 'All-cleft: "All + subject + verb + was + [focus noun phrase]." Past tense is "needed". Note the focus is a noun phrase here, not a verb — unlike the no-cleft which requires a bare infinitive after "was".' },
      { id: 'cq-10', type: 'fill-in-blank', prompt: 'What is wrong with this sentence? "What she did was ignoring us."\nWrite the correct form of the verb only.', answer: 'ignore', acceptedVariants: ['ignore'], explanation: 'In the no-cleft (what-do cleft), the verb after "was" must be a bare infinitive: "What she did was ignore us." Using the gerund "ignoring" is non-standard in this structure.' },
      { id: 'cq-11', type: 'sentence-scramble', prompt: 'Unscramble to form a correct it-cleft sentence:', words: ['It', 'was', 'in', 'Vienna', 'that', 'the', 'treaty', 'was', 'signed', '.'], explanation: '"It was in Vienna that the treaty was signed." — it-cleft focusing on the place. Structure: It + was + in Vienna + that + rest of clause.' },
      { id: 'cq-12', type: 'sentence-scramble', prompt: 'Unscramble to form a correct no-cleft sentence:', words: ['What', 'she', 'did', 'was', 'resign', 'quietly', '.'], explanation: '"What she did was resign quietly." — no-cleft: What + subject + did + was + bare infinitive. "Resign" (bare infinitive) follows "was" directly.' }
    ]
  },
  {
    id: 'c2-rhetoric-quiz',
    lessonId: 'c2-rhetoric-01',
    title: 'Rhetoric & Persuasion Check',
    questions: [
      { id: 'rq-01', type: 'multiple-choice', prompt: 'A politician opens: "As the former head of the IMF, I can state unequivocally that this budget is unsustainable." Which appeal is primarily at work?', options: ['Pathos — she is appealing to fear', 'Logos — she is presenting a logical argument', 'Ethos — she is establishing credibility through her authority', 'Anaphora — she is using repetition for emphasis'], correctIndex: 2, explanation: 'The speaker cites her professional credentials (former IMF head) to establish why the audience should trust her judgment — this is ethos, the appeal to the speaker\'s character and expertise.' },
      { id: 'rq-02', type: 'multiple-choice', prompt: '"Isn\'t it time we finally took this issue seriously?" — What type of device is this, and what does it imply?', options: ['Tricolon; it implies that three actions are needed', 'Anaphora; it repeats a phrase for emphasis', 'Rhetorical question; it implies the audience already agrees the answer is "yes"', 'Concession; it acknowledges the issue has been ignored'], correctIndex: 2, explanation: 'This is a rhetorical question — not asking for an answer but inviting the audience to agree internally. The word "finally" adds an implication of long overdue action.' },
      { id: 'rq-03', type: 'multiple-choice', prompt: 'Identify the tricolon: "The report was thorough, the methodology was sound, and the conclusions were clear."', options: ['"The report was thorough"', '"thorough, sound, and clear" — three adjectives', 'The entire three-clause sentence', '"thorough, the methodology was sound" — two balanced elements'], correctIndex: 2, explanation: 'A tricolon is a series of three parallel grammatical units. Here the tricolon is the whole structure: three independent clauses in parallel.' },
      { id: 'rq-04', type: 'multiple-choice', prompt: 'Which sentence best exemplifies the concession-rebuttal structure?', options: ['"The policy is wrong and should be abandoned immediately."', '"Although concerns about cost are understandable, the long-term economic benefits far outweigh the initial investment."', '"We must act now. We cannot afford to wait. The time is today."', '"Is this truly the best we can offer future generations?"'], correctIndex: 1, explanation: 'Option B follows the classic pattern: "Although + concession, + rebuttal." It acknowledges cost concerns before presenting the counter-argument. Option C uses anaphora. Option D is a rhetorical question.' },
      { id: 'rq-05', type: 'multiple-choice', prompt: '"We saw poverty. We saw neglect. We saw a system that had forgotten its people." — Which device is this?', options: ['Tricolon only — three parallel elements', 'Anaphora with tricolon — "We saw" repeated across three parallel clauses', 'Logos — factual observations as evidence', 'Ethos — establishing the speaker as a witness'], correctIndex: 1, explanation: 'The passage uses both anaphora (repetition of "We saw") and tricolon (three parallel units). Together they create emotional accumulation — pathos — building toward the most damning image.' },
      { id: 'rq-06', type: 'multiple-choice', prompt: 'Which is the most effective use of logos against a proposed tax cut?', options: ['"Think of the schools that will close and the children who will suffer."', '"As a taxpayer myself, I find this proposal deeply offensive."', '"An analysis of similar cuts in six comparable economies shows an average GDP contraction of 1.4% over three years."', '"Is a tax cut really what this country needs right now?"'], correctIndex: 2, explanation: 'Logos requires evidence and rational argument. Option C presents specific, quantifiable data from comparable cases — the strongest logos. Option A is pathos. Option B is weak ethos. Option D is a rhetorical question.' },
      { id: 'rq-07', type: 'multiple-choice', prompt: 'Why do skilled rhetoricians use concession before rebuttal rather than simply attacking opposing arguments?', options: ['Because it makes the speech longer and therefore more impressive', 'Because acknowledging the opposition builds ethos, pre-empts counterattacks, and makes the rebuttal more forceful by contrast', 'Because it is required by the rules of formal debate', 'Because it softens the argument and reduces the chance of offending the audience'], correctIndex: 1, explanation: 'Concession serves three functions: (1) builds ethos by showing fairness; (2) pre-empts the opposing side from raising those points; (3) the contrast between a fair concession and a strong rebuttal makes the rebuttal land with greater force.' },
      { id: 'rq-08', type: 'fill-in-blank', prompt: 'Complete the concession-rebuttal sentence:\n"______ the initial data appeared inconclusive, subsequent analysis revealed a clear and consistent pattern."', answer: 'While', acceptedVariants: ['While', 'Although', 'Even though', 'Whilst'], explanation: '"While," "Although," and "Even though" all introduce a concessive subordinate clause. They acknowledge the concession before the rebuttal. "While" and "Although" are most common in formal written rhetoric.' },
      { id: 'rq-09', type: 'fill-in-blank', prompt: '"We built this company on trust. We built this company on hard work. We built this company on ______." — Complete the anaphora with an appropriate third element.', answer: 'integrity', acceptedVariants: ['integrity', 'honesty', 'principle', 'shared values', 'belief in each other', 'determination'], explanation: 'Anaphora requires parallel structure. The third element should complete the tricolon with something of equal or greater weight. "Integrity", "honesty", and "principle" all fit the rhythm and semantic register.' },
      { id: 'rq-10', type: 'fill-in-blank', prompt: 'What is the rhetorical term for the three-part appeal system described by Aristotle (ethos, pathos, logos)?', answer: 'rhetorical triangle', acceptedVariants: ['rhetorical triangle', "Aristotle's triangle", 'the rhetorical triangle', 'the three appeals'], explanation: 'The system is commonly called "Aristotle\'s rhetorical triangle" or "the rhetorical triangle" — three modes of persuasion that form a triangle of complementary appeals.' },
      { id: 'rq-11', type: 'word-matching', prompt: 'จับคู่คำศัพท์วาทศาสตร์กับคำนิยาม:', pairs: [{ word: 'Ethos', match: 'การอุทธรณ์ต่อความน่าเชื่อถือของผู้พูด' }, { word: 'Anaphora', match: 'การซ้ำคำหรือวลีที่ต้นประโยคติดต่อกัน' }, { word: 'Tricolon', match: 'การใช้สามองค์ประกอบคู่ขนานเพื่อจังหวะ' }, { word: 'Logos', match: 'การอุทธรณ์ต่อเหตุผลและหลักฐาน' }], explanation: 'Ethos = credibility; Anaphora = beginning repetition; Tricolon = three parallel units; Logos = logic/evidence. Note: ethos is about WHO is speaking; logos is about WHAT is argued.' },
      { id: 'rq-12', type: 'word-matching', prompt: 'จับคู่ตัวอย่างประโยคกับ device ที่ใช้:', pairs: [{ word: '"Education, opportunity, and justice — that is our promise."', match: 'Tricolon' }, { word: '"As a mother and a doctor, I have seen this crisis from both sides."', match: 'Ethos' }, { word: '"Can we really call ourselves civilised if we abandon the vulnerable?"', match: 'Rhetorical question' }, { word: '"While critics point to rising costs, the evidence shows a net benefit."', match: 'Concession and rebuttal' }], explanation: 'Each example demonstrates a distinct device: tricolon (three parallel nouns), ethos (dual authority), rhetorical question (invites shared agreement), concession-rebuttal ("While... the evidence shows").' }
    ]
  }
]
